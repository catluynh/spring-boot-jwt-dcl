package com.springbootjwtdcl.util;
...
public class JwtUtil {
	...
	private static final String USER = "luynh";
    private static final String SECRET = "hey Mr luynh the secrect length must be at least 256 bits" +
                                             " please no reveal!";
